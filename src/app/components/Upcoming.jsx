  ...
  return (
    <>
      <div className="w-full">
        ...
        {/* Timeline Wrapper - flex-row layout per group, no absolute offsets */}
        <div className="w-full">
          {scheduleData.map((group, groupIdx) => (
            <div key={groupIdx} className="flex gap-2 sm:gap-3 mb-6 last:mb-0">
              {/* Hour Label */}
              <div className="w-9 sm:w-12 text-right text-xs sm:text-sm font-normal text-gray-400 shrink-0 pt-0.5">
                {group.hour}
              </div>

              {/* Dot + connecting vertical line */}
              <div className="flex flex-col items-center shrink-0">
                <span className="w-2.5 h-2.5 rounded-full bg-black shrink-0 mt-1" />
                        ...
                        {isOpen && item.details && (
                          <div className="mt-2 bg-white border border-gray-200 rounded-xl p-3 sm:p-4 text-sm space-y-3">
                            ...
                            <div className="pt-2 flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 border-t border-gray-100">
                              ...
                              <button className="bg-[#0000AC] text-white px-2 py-1.5 rounded-lg font-medium text-xs hover:bg-opacity-95 transition cursor-pointer w-full sm:w-auto">
                                Begin appointment
                              </button>
                            </div>
                          </div>
