...
export default function Sidebar() {
  ...
  return (
    ...
    >
      ...
      <ul className="border-b border-[#E0E0E0] pb-5  border-t relative">
        <div className="h-5.5 flex w-full pt-5   justify-between items-center ">
          ...
          <button
            ...
            className="cursor-pointer text-blue-800 p-1 bg-gray-100 rounded-full transition-colors absolute -right-8 duration-200 shrink-0"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
