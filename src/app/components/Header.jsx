...
export default function Header() {
  ...
  const handleNavigation = () => {
    // Perform actions here (like API calls) before navigating
    router.push("/signup");
  };
  ...
  return (
    <>
      <header className="h-23.5 border-b bg-white border-[#E0E0E0] flex justify-start items-center gap-2">
        <section className="  border-r border-b border-[#E0E0E0] w-[16%] h-23.5 flex justify-center items-center">
          <Image
            src={"/icons/logo.svg"}
            alt="website logo"
            width={100}
        ...
        <section className="flex justify-evenly gap-3 ">
          <div className="w-138 my-auto">
            <div className="border border-[#E0E0E0] rounded-md flex justify-between items-center px-2  h-[41px]">
              <input type="search" className="w-full py-2 border-0 outline-0" />
              <span>
                <svg
